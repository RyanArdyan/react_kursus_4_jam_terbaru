...
// komponen adalah function yang mengembalikkan tampilan dan melakukan kode javacript
// komponent header berisi menjalankan fungsi berikut
const Header = () => {
// kembalkkan tampilan berikut
  return (
    // gunakan <> untuk mengimpor banyak komponen dan tampilan html
    <>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <nav className="mt-2">
                    <ul className="flex space-x-4 mb-3">
                        {/* elemet Link digunakan untuk mengganti elemet a. Element a akan melakukan refresh browser sedangkan Link tidak melakukan refresh browser */}
                        ...
                        <li><Link to="/tahap4" className="text-gray-600 hover:text-blue-500">Tahap 4</Link></li>
                    </ul>
                </nav>
            </div>
        </header>        
